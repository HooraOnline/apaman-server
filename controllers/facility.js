...
router.get('/type2/:BuildingID', function (req, res) {
...
router.post('/reserveByManuallyPayment/:CallerFormID.:CallerBuildingID.:CallerUnitID.:CallerRoleID', function (req, res) {
    ...
    request.input('BuildingID', sql.BigInt, req.params.CallerBuildingID);
...
router.get('/getUserReserved/:CallerFormID.:CallerBuildingID.:CallerUnitID.:CallerRoleID.:UserID', function (req, res) {
